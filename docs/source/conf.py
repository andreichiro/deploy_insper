...
# insper_deploy_kedro documentation build
...
from insper_deploy_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "insper_deploy_kedro"
author = "Kedro"
...
htmlhelp_basename = "insper_deploy_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "insper_deploy_kedro.tex",
        "insper_deploy_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "insper_deploy_kedro",
        "Project insper_deploy_kedro codebase.",
        "Data-Science",
    )
]
